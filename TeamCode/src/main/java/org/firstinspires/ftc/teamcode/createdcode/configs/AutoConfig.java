...
public class AutoConfig {
    ...
    public static int LAYER_ONE_FRONT_ARM_POS = 70;
    public static int LAYER_TWO_FRONT_ARM_POS = 45;
    public static int LAYER_THREE_FRONT_ARM_POS = -0;

    //grabber constants
    public static int GRAB_TIME = 2000;
